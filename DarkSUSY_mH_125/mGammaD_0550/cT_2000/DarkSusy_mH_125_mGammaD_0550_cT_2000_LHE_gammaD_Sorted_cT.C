...
//=========  (Wed Mar 18 13:39:59 2015) by ROOT version5.34/18
   ...
   cnv->Range(-21.25,-0.009297649,103.75,0.06222273);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,100);
   h_gammaD_1_cT_dummy->SetMaximum(0.05721631);
   ...
   h_gammaD_1_cT_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 20.0 mm");
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,100);
   h_gammaD_1_cT->SetBinContent(1,0.03188764);
   h_gammaD_1_cT->SetBinContent(2,0.01170965);
   h_gammaD_1_cT->SetBinContent(3,0.004315673);
   h_gammaD_1_cT->SetBinContent(4,0.001511146);
   h_gammaD_1_cT->SetBinContent(5,0.0005758846);
   h_gammaD_1_cT->SetBinContent(6,0.0003499364);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,100);
   h_gammaD_2_cT->SetBinContent(1,0.03178684);
   h_gammaD_2_cT->SetBinContent(2,0.01177614);
   h_gammaD_2_cT->SetBinContent(3,0.004265761);
   h_gammaD_2_cT->SetBinContent(4,0.001547754);
   h_gammaD_2_cT->SetBinContent(5,0.0006235057);
   h_gammaD_2_cT->SetBinContent(6,0.00033283);
