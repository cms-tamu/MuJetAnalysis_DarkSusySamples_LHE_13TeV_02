...
//=========  (Mon Mar 16 13:44:36 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-1.929926,0.259375,12.91566);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",5,0,0.25);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(11.87647);
   ...
   h_gammaD_1_cT_Z_lab_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 0.05 mm");
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",5,0,0.25);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,5.773159);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,4.388613);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,3.770447);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,3.159512);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,2.908269);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,124.5983);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",5,0,0.25);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,6.598037);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,4.682786);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,3.470433);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,2.901604);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,2.347139);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,56.60905);
