...
//=========  (Mon Mar 16 13:44:31 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.705576,0.259375,24.79886);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,0.25);
   h_gammaD_1_cT_dummy->SetMaximum(22.80355);
   ...
   h_gammaD_1_cT_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 0.05 mm");
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,0.25);
   h_gammaD_1_cT->SetBinContent(1,12.75676);
   h_gammaD_1_cT->SetBinContent(2,4.639966);
   h_gammaD_1_cT->SetBinContent(3,1.732496);
   h_gammaD_1_cT->SetBinContent(4,0.6355842);
   h_gammaD_1_cT->SetBinContent(5,0.2351964);
   h_gammaD_1_cT->SetBinContent(6,0.1450461);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,0.25);
   h_gammaD_2_cT->SetBinContent(1,12.66864);
   h_gammaD_2_cT->SetBinContent(2,4.744637);
   h_gammaD_2_cT->SetBinContent(3,1.707455);
   h_gammaD_2_cT->SetBinContent(4,0.6464926);
   h_gammaD_2_cT->SetBinContent(5,0.2327776);
   h_gammaD_2_cT->SetBinContent(6,0.1318654);
