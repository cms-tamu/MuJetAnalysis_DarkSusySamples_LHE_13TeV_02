...
//=========  (Mon Mar 16 14:01:07 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.09875429,5.1875,0.6608941);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",5,0,5);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(0.6077187);
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",5,0,5);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.2783329);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.2280133);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.1855253);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.1582501);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.1498785);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,6.201278);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",5,0,5);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.3376215);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.230465);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.1765771);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.1378883);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.1174481);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,2.811654);
