...
//=========  (Mon Mar 16 13:48:57 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.860059,0.51875,12.44809);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,0.5);
   h_gammaD_1_cT_dummy->SetMaximum(11.44652);
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,0.5);
   h_gammaD_1_cT->SetBinContent(1,6.351501);
   h_gammaD_1_cT->SetBinContent(2,2.338391);
   h_gammaD_1_cT->SetBinContent(3,0.8639692);
   h_gammaD_1_cT->SetBinContent(4,0.3305151);
   h_gammaD_1_cT->SetBinContent(5,0.1156237);
   h_gammaD_1_cT->SetBinContent(6,0.06504618);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,0.5);
   h_gammaD_2_cT->SetBinContent(1,6.359176);
   h_gammaD_2_cT->SetBinContent(2,2.344682);
   h_gammaD_2_cT->SetBinContent(3,0.8566719);
   h_gammaD_2_cT->SetBinContent(4,0.3291311);
   h_gammaD_2_cT->SetBinContent(5,0.1103394);
   h_gammaD_2_cT->SetBinContent(6,0.06504618);
