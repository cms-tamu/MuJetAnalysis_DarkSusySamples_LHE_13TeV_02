...
//=========  (Wed Mar 18 13:39:44 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-53.125,-0.003721388,259.375,0.02490468);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02290085);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01271826);
   h_gammaD_1_cT->SetBinContent(2,0.004696972);
   h_gammaD_1_cT->SetBinContent(3,0.001730477);
   h_gammaD_1_cT->SetBinContent(4,0.0006212806);
   h_gammaD_1_cT->SetBinContent(5,0.0002330117);
   h_gammaD_1_cT->SetBinContent(6,0.0001303456);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.0127227);
   h_gammaD_2_cT->SetBinContent(2,0.00466863);
   h_gammaD_2_cT->SetBinContent(3,0.00171663);
   h_gammaD_2_cT->SetBinContent(4,0.0006662639);
   h_gammaD_2_cT->SetBinContent(5,0.0002257797);
   h_gammaD_2_cT->SetBinContent(6,0.0001361726);
