...
//=========  (Wed Mar 18 13:39:59 2015) by ROOT version5.34/18
   ...
   cnv->Range(-53.125,-0.001937886,259.375,0.01296893);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",5,0,250);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(0.01192545);
   ...
   h_gammaD_1_cT_Z_lab_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 50.0 mm");
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",5,0,250);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.005674177);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.004470672);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.003810801);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.003186695);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.002857654);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,0.1230597);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",5,0,250);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.006625251);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.004670744);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.003555386);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.002803211);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.002345408);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,0.05645895);
