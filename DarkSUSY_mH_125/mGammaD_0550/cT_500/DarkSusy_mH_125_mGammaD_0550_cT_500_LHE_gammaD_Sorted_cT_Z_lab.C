...
//=========  (Mon Mar 16 14:13:42 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.01915885,25.9375,0.1282169);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",5,0,25);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(0.1179006);
   ...
   h_gammaD_1_cT_Z_lab_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 5.0 mm");
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",5,0,25);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.05763321);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.04377752);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.03730793);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.03159314);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.0296882);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,1.237667);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",5,0,25);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.06550036);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.04522938);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.03595912);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.02875208);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.02455907);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,0.5606275);
