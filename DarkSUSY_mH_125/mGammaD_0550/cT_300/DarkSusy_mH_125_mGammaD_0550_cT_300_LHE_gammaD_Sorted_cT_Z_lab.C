...
//=========  (Mon Mar 16 14:09:07 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.03209193,15.5625,0.2147691);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",5,0,15);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(0.1974888);
   ...
   h_gammaD_1_cT_Z_lab_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 3.0 mm");
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",5,0,15);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.09500343);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.07526207);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.05937341);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.05399755);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.04969686);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,2.055909);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",5,0,15);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.109716);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.07573644);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.05784064);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.04844374);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.04159651);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,0.9495037);
