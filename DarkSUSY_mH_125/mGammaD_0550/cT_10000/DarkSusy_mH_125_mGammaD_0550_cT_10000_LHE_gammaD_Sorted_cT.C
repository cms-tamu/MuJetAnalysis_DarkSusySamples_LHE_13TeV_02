...
//=========  (Wed Mar 18 13:39:14 2015) by ROOT version5.34/18
   ...
   cnv->Range(-106.25,-0.001864311,518.75,0.01247655);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01147269);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006351076);
   h_gammaD_1_cT->SetBinContent(2,0.00236001);
   h_gammaD_1_cT->SetBinContent(3,0.0008637222);
   h_gammaD_1_cT->SetBinContent(4,0.0003149616);
   h_gammaD_1_cT->SetBinContent(5,0.0001102303);
   h_gammaD_1_cT->SetBinContent(6,6.6566e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006373715);
   h_gammaD_2_cT->SetBinContent(2,0.002330779);
   h_gammaD_2_cT->SetBinContent(3,0.0008677816);
   h_gammaD_2_cT->SetBinContent(4,0.0003098141);
   h_gammaD_2_cT->SetBinContent(5,0.0001179106);
   h_gammaD_2_cT->SetBinContent(6,6.694603e-05);
