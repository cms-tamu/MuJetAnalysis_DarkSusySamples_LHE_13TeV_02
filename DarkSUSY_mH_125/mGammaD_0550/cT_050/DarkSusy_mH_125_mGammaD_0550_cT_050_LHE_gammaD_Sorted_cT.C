...
//=========  (Mon Mar 16 13:57:04 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.3713919,2.59375,2.485469);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,2.5);
   h_gammaD_1_cT_dummy->SetMaximum(2.285488);
   ...
   h_gammaD_1_cT_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 0.5 mm");
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,2.5);
   h_gammaD_1_cT->SetBinContent(1,1.266089);
   h_gammaD_1_cT->SetBinContent(2,0.4703262);
   h_gammaD_1_cT->SetBinContent(3,0.1744316);
   h_gammaD_1_cT->SetBinContent(4,0.06549993);
   h_gammaD_1_cT->SetBinContent(5,0.02365345);
   h_gammaD_1_cT->SetBinContent(6,0.01303456);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,2.5);
   h_gammaD_2_cT->SetBinContent(1,1.269716);
   h_gammaD_2_cT->SetBinContent(2,0.4710902);
   h_gammaD_2_cT->SetBinContent(3,0.172754);
   h_gammaD_2_cT->SetBinContent(4,0.06398671);
   h_gammaD_2_cT->SetBinContent(5,0.02245324);
   h_gammaD_2_cT->SetBinContent(6,0.01371863);
