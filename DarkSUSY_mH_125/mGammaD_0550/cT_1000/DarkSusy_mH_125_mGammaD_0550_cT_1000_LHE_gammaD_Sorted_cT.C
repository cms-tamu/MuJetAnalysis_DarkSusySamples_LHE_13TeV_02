...
//=========  (Wed Mar 18 13:33:36 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01853581,51.875,0.1240473);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,50);
   h_gammaD_1_cT_dummy->SetMaximum(0.1140665);
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,50);
   h_gammaD_1_cT->SetBinContent(1,0.06388665);
   h_gammaD_1_cT->SetBinContent(2,0.02320188);
   h_gammaD_1_cT->SetBinContent(3,0.008604288);
   h_gammaD_1_cT->SetBinContent(4,0.003148279);
   h_gammaD_1_cT->SetBinContent(5,0.001158899);
   h_gammaD_1_cT->SetBinContent(6,0.0006631266);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,50);
   h_gammaD_2_cT->SetBinContent(1,0.06337029);
   h_gammaD_2_cT->SetBinContent(2,0.02372815);
   h_gammaD_2_cT->SetBinContent(3,0.008528898);
   h_gammaD_2_cT->SetBinContent(4,0.003198651);
   h_gammaD_2_cT->SetBinContent(5,0.001174013);
   h_gammaD_2_cT->SetBinContent(6,0.0006643933);
