...
//=========  (Mon Mar 16 14:05:07 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.09343356,10.375,0.6252862);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5749758);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3185377);
   h_gammaD_1_cT->SetBinContent(2,0.1169277);
   h_gammaD_1_cT->SetBinContent(3,0.04302727);
   h_gammaD_1_cT->SetBinContent(4,0.01570407);
   h_gammaD_1_cT->SetBinContent(5,0.005803268);
   h_gammaD_1_cT->SetBinContent(6,0.003531056);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.319431);
   h_gammaD_2_cT->SetBinContent(2,0.1157257);
   h_gammaD_2_cT->SetBinContent(3,0.04322261);
   h_gammaD_2_cT->SetBinContent(4,0.01567787);
   h_gammaD_2_cT->SetBinContent(5,0.005942873);
   h_gammaD_2_cT->SetBinContent(6,0.003094067);
