...
//=========  (Wed Mar 18 13:33:55 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-21.25,-0.009304258,103.75,0.06226696);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05725697);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.031808);
   h_gammaD_1_cT->SetBinContent(2,0.0116945);
   h_gammaD_1_cT->SetBinContent(3,0.004343203);
   h_gammaD_1_cT->SetBinContent(4,0.001572311);
   h_gammaD_1_cT->SetBinContent(5,0.000581988);
   h_gammaD_1_cT->SetBinContent(6,0.0003334634);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03180943);
   h_gammaD_2_cT->SetBinContent(2,0.01176248);
   h_gammaD_2_cT->SetBinContent(3,0.004334474);
   h_gammaD_2_cT->SetBinContent(4,0.00152726);
   h_gammaD_2_cT->SetBinContent(5,0.0005663512);
   h_gammaD_2_cT->SetBinContent(6,0.0003416986);
