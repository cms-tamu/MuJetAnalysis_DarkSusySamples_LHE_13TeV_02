...
//=========  (Mon Mar 16 13:12:03 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.738424,0.259375,25.01869);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(23.00569);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.72112);
   h_gammaD_1_cT->SetBinContent(2,4.669519);
   h_gammaD_1_cT->SetBinContent(3,1.734961);
   h_gammaD_1_cT->SetBinContent(4,0.6418324);
   h_gammaD_1_cT->SetBinContent(5,0.2325698);
   h_gammaD_1_cT->SetBinContent(6,0.1356657);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.78094);
   h_gammaD_2_cT->SetBinContent(2,4.658393);
   h_gammaD_2_cT->SetBinContent(3,1.703001);
   h_gammaD_2_cT->SetBinContent(4,0.6253147);
   h_gammaD_2_cT->SetBinContent(5,0.2323532);
   h_gammaD_2_cT->SetBinContent(6,0.1387071);
