...
//=========  (Mon Mar 16 13:20:20 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9316737,1.0375,6.235047);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.733377);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.195069);
   h_gammaD_1_cT->SetBinContent(2,1.165087);
   h_gammaD_1_cT->SetBinContent(3,0.4217171);
   h_gammaD_1_cT->SetBinContent(4,0.1580888);
   h_gammaD_1_cT->SetBinContent(5,0.06003851);
   h_gammaD_1_cT->SetBinContent(6,0.0346134);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.18521);
   h_gammaD_2_cT->SetBinContent(2,1.171005);
   h_gammaD_2_cT->SetBinContent(3,0.4256885);
   h_gammaD_2_cT->SetBinContent(4,0.1613553);
   h_gammaD_2_cT->SetBinContent(5,0.05674169);
   h_gammaD_2_cT->SetBinContent(6,0.03245977);
