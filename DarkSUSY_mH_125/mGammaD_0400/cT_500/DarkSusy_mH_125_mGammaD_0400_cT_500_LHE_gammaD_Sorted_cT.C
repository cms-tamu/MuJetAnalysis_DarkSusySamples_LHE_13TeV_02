...
//=========  (Mon Mar 16 13:40:21 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03725436,25.9375,0.2493177);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2292576);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.126935);
   h_gammaD_1_cT->SetBinContent(2,0.04700597);
   h_gammaD_1_cT->SetBinContent(3,0.01735256);
   h_gammaD_1_cT->SetBinContent(4,0.006421002);
   h_gammaD_1_cT->SetBinContent(5,0.002285484);
   h_gammaD_1_cT->SetBinContent(6,0.001361726);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1273654);
   h_gammaD_2_cT->SetBinContent(2,0.04685668);
   h_gammaD_2_cT->SetBinContent(3,0.01704611);
   h_gammaD_2_cT->SetBinContent(4,0.006409902);
   h_gammaD_2_cT->SetBinContent(5,0.002321954);
   h_gammaD_2_cT->SetBinContent(6,0.001250283);
