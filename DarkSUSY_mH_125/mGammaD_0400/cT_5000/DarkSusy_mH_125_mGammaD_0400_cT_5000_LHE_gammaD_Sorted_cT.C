...
//=========  (Wed Mar 18 13:34:00 2015) by ROOT version5.34/18
   ...
   cnv->Range(-53.125,-0.003729932,259.375,0.02496185);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02295343);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01271686);
   h_gammaD_1_cT->SetBinContent(2,0.004719831);
   h_gammaD_1_cT->SetBinContent(3,0.001687811);
   h_gammaD_1_cT->SetBinContent(4,0.0006366108);
   h_gammaD_1_cT->SetBinContent(5,0.0002388864);
   h_gammaD_1_cT->SetBinContent(6,0.0001376932);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.0127519);
   h_gammaD_2_cT->SetBinContent(2,0.004690715);
   h_gammaD_2_cT->SetBinContent(3,0.001707019);
   h_gammaD_2_cT->SetBinContent(4,0.0006259994);
   h_gammaD_2_cT->SetBinContent(5,0.0002243626);
   h_gammaD_2_cT->SetBinContent(6,0.0001445389);
