...
//=========  (Mon Mar 16 13:16:02 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.858739,0.51875,12.43926);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.4384);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.387844);
   h_gammaD_1_cT->SetBinContent(2,2.31343);
   h_gammaD_1_cT->SetBinContent(3,0.8706809);
   h_gammaD_1_cT->SetBinContent(4,0.3152162);
   h_gammaD_1_cT->SetBinContent(5,0.1128288);
   h_gammaD_1_cT->SetBinContent(6,0.06264072);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.354665);
   h_gammaD_2_cT->SetBinContent(2,2.34102);
   h_gammaD_2_cT->SetBinContent(3,0.873823);
   h_gammaD_2_cT->SetBinContent(4,0.3164493);
   h_gammaD_2_cT->SetBinContent(5,0.1140426);
   h_gammaD_2_cT->SetBinContent(6,0.06986053);
