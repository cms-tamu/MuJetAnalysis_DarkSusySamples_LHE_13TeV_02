...
//=========  (Sun Mar 15 20:35:20 2015) by ROOT version5.34/18
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",10,0,10);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(1.8);
   ...
   h_gammaD_1_cT_Z_lab_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 1 mm");
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",10,0,10);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,1);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",10,0,10);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,1);
