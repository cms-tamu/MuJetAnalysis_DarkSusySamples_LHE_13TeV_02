...
//=========  (Sun Mar 15 20:32:58 2015) by ROOT version5.34/18
   ...
   h_higgs_M__5->SetBinError(5,0.003535556);
   h_higgs_M__5->SetEntries(79999);
   ...
   h_higgs_M__7->SetBinError(5,0.003535556);
   h_higgs_M__7->SetEntries(79999);
