...
//=========  (Mon Mar 16 13:32:20 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09305831,10.375,0.6227748);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5726665);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3173308);
   h_gammaD_1_cT->SetBinContent(2,0.1177967);
   h_gammaD_1_cT->SetBinContent(3,0.04315392);
   h_gammaD_1_cT->SetBinContent(4,0.01586402);
   h_gammaD_1_cT->SetBinContent(5,0.00585458);
   h_gammaD_1_cT->SetBinContent(6,0.003613472);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3181481);
   h_gammaD_2_cT->SetBinContent(2,0.1157743);
   h_gammaD_2_cT->SetBinContent(3,0.04388813);
   h_gammaD_2_cT->SetBinContent(4,0.01622363);
   h_gammaD_2_cT->SetBinContent(5,0.005965866);
   h_gammaD_2_cT->SetBinContent(6,0.00344233);
