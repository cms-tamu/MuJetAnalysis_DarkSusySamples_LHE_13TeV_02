...
//=========  (Wed Mar 18 13:33:49 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01859701,51.875,0.1244569);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1144431);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06362469);
   h_gammaD_1_cT->SetBinContent(2,0.02335393);
   h_gammaD_1_cT->SetBinContent(3,0.008684274);
   h_gammaD_1_cT->SetBinContent(4,0.003200926);
   h_gammaD_1_cT->SetBinContent(5,0.001136178);
   h_gammaD_1_cT->SetBinContent(6,0.0006567938);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06357951);
   h_gammaD_2_cT->SetBinContent(2,0.02354555);
   h_gammaD_2_cT->SetBinContent(3,0.008639909);
   h_gammaD_2_cT->SetBinContent(4,0.003068696);
   h_gammaD_2_cT->SetBinContent(5,0.001166331);
   h_gammaD_2_cT->SetBinContent(6,0.0006529944);
