...
//=========  (Mon Mar 16 13:28:22 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.1863859,5.1875,1.247352);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.14699);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6366634);
   h_gammaD_1_cT->SetBinContent(2,0.2343125);
   h_gammaD_1_cT->SetBinContent(3,0.08639785);
   h_gammaD_1_cT->SetBinContent(4,0.03141282);
   h_gammaD_1_cT->SetBinContent(5,0.01121347);
   h_gammaD_1_cT->SetBinContent(6,0.006808628);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6372168);
   h_gammaD_2_cT->SetBinContent(2,0.233083);
   h_gammaD_2_cT->SetBinContent(3,0.0877961);
   h_gammaD_2_cT->SetBinContent(4,0.03093432);
   h_gammaD_2_cT->SetBinContent(5,0.0109698);
   h_gammaD_2_cT->SetBinContent(6,0.006390661);
