...
//=========  (Wed Mar 18 13:39:53 2015) by ROOT version5.34/18
   ...
   cnv->Range(-53.125,-0.003732268,259.375,0.02497749);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02296781);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01270654);
   h_gammaD_1_cT->SetBinContent(2,0.004688975);
   h_gammaD_1_cT->SetBinContent(3,0.00172659);
   h_gammaD_1_cT->SetBinContent(4,0.000629727);
   h_gammaD_1_cT->SetBinContent(5,0.0002481658);
   h_gammaD_1_cT->SetBinContent(6,0.0001349056);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01275989);
   h_gammaD_2_cT->SetBinContent(2,0.004687323);
   h_gammaD_2_cT->SetBinContent(3,0.001681292);
   h_gammaD_2_cT->SetBinContent(4,0.0006428544);
   h_gammaD_2_cT->SetBinContent(5,0.0002286376);
   h_gammaD_2_cT->SetBinContent(6,0.0001440316);
