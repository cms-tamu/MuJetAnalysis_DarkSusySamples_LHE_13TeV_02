...
//=========  (Mon Mar 16 14:47:18 2015) by ROOT version5.34/18
   ...
   cnv->Range(-3.1875,-0.06189737,15.5625,0.4142363);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3809069);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2129738);
   h_gammaD_1_cT->SetBinContent(2,0.07770773);
   h_gammaD_1_cT->SetBinContent(3,0.02855477);
   h_gammaD_1_cT->SetBinContent(4,0.01035572);
   h_gammaD_1_cT->SetBinContent(5,0.003741313);
   h_gammaD_1_cT->SetBinContent(6,0.0022062);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.211615);
   h_gammaD_2_cT->SetBinContent(2,0.07876339);
   h_gammaD_2_cT->SetBinContent(3,0.02851076);
   h_gammaD_2_cT->SetBinContent(4,0.01062964);
   h_gammaD_2_cT->SetBinContent(5,0.003814584);
   h_gammaD_2_cT->SetBinContent(6,0.002379394);
