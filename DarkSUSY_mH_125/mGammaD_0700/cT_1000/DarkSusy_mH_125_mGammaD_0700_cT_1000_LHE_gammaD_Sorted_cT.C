...
//=========  (Wed Mar 18 13:38:55 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01869498,51.875,0.1251125);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.115046);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06365077);
   h_gammaD_1_cT->SetBinContent(2,0.02332817);
   h_gammaD_1_cT->SetBinContent(3,0.008657632);
   h_gammaD_1_cT->SetBinContent(4,0.003237333);
   h_gammaD_1_cT->SetBinContent(5,0.001126084);
   h_gammaD_1_cT->SetBinContent(6,0.0006542609);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06391445);
   h_gammaD_2_cT->SetBinContent(2,0.02323166);
   h_gammaD_2_cT->SetBinContent(3,0.008605345);
   h_gammaD_2_cT->SetBinContent(4,0.003079092);
   h_gammaD_2_cT->SetBinContent(5,0.001169451);
   h_gammaD_2_cT->SetBinContent(6,0.0007049434);
