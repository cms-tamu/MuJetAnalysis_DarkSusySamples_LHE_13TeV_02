...
//=========  (Mon Mar 16 14:45:33 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-0.9899071,0.51875,6.624763);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",5,0,0.5);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(6.091736);
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",5,0,0.5);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,2.927987);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,2.158108);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,1.925461);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,1.590266);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,1.398179);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,51.22216);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",5,0,0.5);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,3.384298);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,2.318676);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,1.747115);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,1.371409);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,1.178502);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,23.69514);
