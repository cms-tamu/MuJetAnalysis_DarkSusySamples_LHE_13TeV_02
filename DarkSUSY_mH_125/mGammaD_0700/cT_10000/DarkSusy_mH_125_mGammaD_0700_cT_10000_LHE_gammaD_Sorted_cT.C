...
//=========  (Wed Mar 18 13:39:54 2015) by ROOT version5.34/18
   ...
   cnv->Range(-106.25,-0.001859718,518.75,0.0124458);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01144442);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006369379);
   h_gammaD_1_cT->SetBinContent(2,0.002333665);
   h_gammaD_1_cT->SetBinContent(3,0.000864805);
   h_gammaD_1_cT->SetBinContent(4,0.0003136051);
   h_gammaD_1_cT->SetBinContent(5,0.0001185457);
   h_gammaD_1_cT->SetBinContent(6,6.745278e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.00635801);
   h_gammaD_2_cT->SetBinContent(2,0.002333354);
   h_gammaD_2_cT->SetBinContent(3,0.0008793006);
   h_gammaD_2_cT->SetBinContent(4,0.0003112145);
   h_gammaD_2_cT->SetBinContent(5,0.0001181206);
   h_gammaD_2_cT->SetBinContent(6,6.340021e-05);
