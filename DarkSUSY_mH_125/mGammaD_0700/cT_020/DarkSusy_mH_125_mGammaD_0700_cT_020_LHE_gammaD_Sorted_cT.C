...
//=========  (Mon Mar 16 14:46:07 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9303821,1.0375,6.226403);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.725428);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.176657);
   h_gammaD_1_cT->SetBinContent(2,1.18061);
   h_gammaD_1_cT->SetBinContent(3,0.4262229);
   h_gammaD_1_cT->SetBinContent(4,0.1560887);
   h_gammaD_1_cT->SetBinContent(5,0.06042144);
   h_gammaD_1_cT->SetBinContent(6,0.03505702);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.180794);
   h_gammaD_2_cT->SetBinContent(2,1.164826);
   h_gammaD_2_cT->SetBinContent(3,0.432119);
   h_gammaD_2_cT->SetBinContent(4,0.1622571);
   h_gammaD_2_cT->SetBinContent(5,0.06000428);
   h_gammaD_2_cT->SetBinContent(6,0.03702258);
