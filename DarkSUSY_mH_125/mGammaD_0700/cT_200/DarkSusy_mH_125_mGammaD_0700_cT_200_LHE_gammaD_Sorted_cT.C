...
//=========  (Mon Mar 16 14:48:53 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09341019,10.375,0.6251298);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.574832);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.317064);
   h_gammaD_1_cT->SetBinContent(2,0.1180746);
   h_gammaD_1_cT->SetBinContent(3,0.04332066);
   h_gammaD_1_cT->SetBinContent(4,0.01585823);
   h_gammaD_1_cT->SetBinContent(5,0.005682533);
   h_gammaD_1_cT->SetBinContent(6,0.003429657);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3193511);
   h_gammaD_2_cT->SetBinContent(2,0.1166402);
   h_gammaD_2_cT->SetBinContent(3,0.04292205);
   h_gammaD_2_cT->SetBinContent(4,0.015461);
   h_gammaD_2_cT->SetBinContent(5,0.005625613);
   h_gammaD_2_cT->SetBinContent(6,0.003404314);
