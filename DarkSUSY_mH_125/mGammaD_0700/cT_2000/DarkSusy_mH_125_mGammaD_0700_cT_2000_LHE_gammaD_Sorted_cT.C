...
//=========  (Wed Mar 18 13:39:52 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-21.25,-0.009322549,103.75,0.06238937);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05736953);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03173798);
   h_gammaD_1_cT->SetBinContent(2,0.0117298);
   h_gammaD_1_cT->SetBinContent(3,0.004371382);
   h_gammaD_1_cT->SetBinContent(4,0.001596401);
   h_gammaD_1_cT->SetBinContent(5,0.0005644349);
   h_gammaD_1_cT->SetBinContent(6,0.0003391644);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03187196);
   h_gammaD_2_cT->SetBinContent(2,0.01171865);
   h_gammaD_2_cT->SetBinContent(3,0.004273343);
   h_gammaD_2_cT->SetBinContent(4,0.001591018);
   h_gammaD_2_cT->SetBinContent(5,0.0005450243);
   h_gammaD_2_cT->SetBinContent(6,0.0003480351);
