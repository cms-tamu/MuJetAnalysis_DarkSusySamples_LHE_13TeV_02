...
//=========  (Mon Mar 16 14:45:49 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.1861046,5.1875,1.245469);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.145259);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6358992);
   h_gammaD_1_cT->SetBinContent(2,0.2354111);
   h_gammaD_1_cT->SetBinContent(3,0.08547019);
   h_gammaD_1_cT->SetBinContent(4,0.03178238);
   h_gammaD_1_cT->SetBinContent(5,0.01143713);
   h_gammaD_1_cT->SetBinContent(6,0.006555273);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6362549);
   h_gammaD_2_cT->SetBinContent(2,0.2343136);
   h_gammaD_2_cT->SetBinContent(3,0.08660237);
   h_gammaD_2_cT->SetBinContent(4,0.03202739);
   h_gammaD_2_cT->SetBinContent(5,0.01080169);
   h_gammaD_2_cT->SetBinContent(6,0.007138181);
