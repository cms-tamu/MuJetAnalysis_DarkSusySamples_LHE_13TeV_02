...
//=========  (Mon Mar 16 14:47:51 2015) by ROOT version5.34/18
   ...
   cnv->Range(-5.3125,-0.03725618,25.9375,0.2493299);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2292688);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1274844);
   h_gammaD_1_cT->SetBinContent(2,0.04704594);
   h_gammaD_1_cT->SetBinContent(3,0.01705362);
   h_gammaD_1_cT->SetBinContent(4,0.00613588);
   h_gammaD_1_cT->SetBinContent(5,0.002280192);
   h_gammaD_1_cT->SetBinContent(6,0.001338921);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1273716);
   h_gammaD_2_cT->SetBinContent(2,0.04669402);
   h_gammaD_2_cT->SetBinContent(3,0.01731897);
   h_gammaD_2_cT->SetBinContent(4,0.006302384);
   h_gammaD_2_cT->SetBinContent(5,0.002313055);
   h_gammaD_2_cT->SetBinContent(6,0.001351589);
