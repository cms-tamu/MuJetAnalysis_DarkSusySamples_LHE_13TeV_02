...
//=========  (Mon Mar 16 14:42:51 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.715608,0.259375,24.86599);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.86528);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.75777);
   h_gammaD_1_cT->SetBinContent(2,4.689065);
   h_gammaD_1_cT->SetBinContent(3,1.693469);
   h_gammaD_1_cT->SetBinContent(4,0.6251416);
   h_gammaD_1_cT->SetBinContent(5,0.2345539);
   h_gammaD_1_cT->SetBinContent(6,0.133132);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.70293);
   h_gammaD_2_cT->SetBinContent(2,4.679432);
   h_gammaD_2_cT->SetBinContent(3,1.752806);
   h_gammaD_2_cT->SetBinContent(4,0.627296);
   h_gammaD_2_cT->SetBinContent(5,0.2375321);
   h_gammaD_2_cT->SetBinContent(6,0.1295858);
