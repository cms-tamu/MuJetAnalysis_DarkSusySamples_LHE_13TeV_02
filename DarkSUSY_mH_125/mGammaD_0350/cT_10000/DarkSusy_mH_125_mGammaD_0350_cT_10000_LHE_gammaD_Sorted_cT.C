...
//=========  (Wed Mar 18 13:33:13 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-106.25,-0.001860383,518.75,0.01245026);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01144851);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.00636017);
   h_gammaD_1_cT->SetBinContent(2,0.002347307);
   h_gammaD_1_cT->SetBinContent(3,0.0008621015);
   h_gammaD_1_cT->SetBinContent(4,0.0003122443);
   h_gammaD_1_cT->SetBinContent(5,0.0001181771);
   h_gammaD_1_cT->SetBinContent(6,6.8213e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006360285);
   h_gammaD_2_cT->SetBinContent(2,0.002346117);
   h_gammaD_2_cT->SetBinContent(3,0.0008611405);
   h_gammaD_2_cT->SetBinContent(4,0.0003136796);
   h_gammaD_2_cT->SetBinContent(5,0.000118778);
   h_gammaD_2_cT->SetBinContent(6,6.580603e-05);
