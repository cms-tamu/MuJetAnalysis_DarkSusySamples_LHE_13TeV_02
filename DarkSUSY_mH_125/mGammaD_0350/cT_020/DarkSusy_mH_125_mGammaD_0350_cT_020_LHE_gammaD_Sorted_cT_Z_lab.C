...
//=========  (Mon Mar 16 12:49:44 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.4734917,1.0375,3.168752);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",5,0,1);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(2.913795);
   ...
   h_gammaD_1_cT_Z_lab_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 0.2 mm");
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",5,0,1);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,1.367034);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,1.081495);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.9522059);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.8866422);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.7126225);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,44.01899);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",5,0,1);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,1.618775);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,1.136613);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.8927919);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.6998052);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.6520151);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,19.35133);
