...
//=========  (Mon Mar 16 12:49:40 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9280368,1.0375,6.210708);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,1);
   h_gammaD_1_cT_dummy->SetMaximum(5.710996);
   ...
   h_gammaD_1_cT_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 0.2 mm");
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,1);
   h_gammaD_1_cT->SetBinContent(1,3.167382);
   h_gammaD_1_cT->SetBinContent(2,1.177411);
   h_gammaD_1_cT->SetBinContent(3,0.4342465);
   h_gammaD_1_cT->SetBinContent(4,0.1630784);
   h_gammaD_1_cT->SetBinContent(5,0.05788275);
   h_gammaD_1_cT->SetBinContent(6,0.03321967);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,1);
   h_gammaD_2_cT->SetBinContent(1,3.172776);
   h_gammaD_2_cT->SetBinContent(2,1.168079);
   h_gammaD_2_cT->SetBinContent(3,0.4377306);
   h_gammaD_2_cT->SetBinContent(4,0.1613553);
   h_gammaD_2_cT->SetBinContent(5,0.06005968);
   h_gammaD_2_cT->SetBinContent(6,0.03638836);
