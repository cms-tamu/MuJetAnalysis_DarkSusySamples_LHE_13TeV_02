...
//=========  (Mon Mar 16 13:03:48 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.0621174,15.5625,0.4157087);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,15);
   h_gammaD_1_cT_dummy->SetMaximum(0.3822609);
   ...
   h_gammaD_1_cT_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 3.0 mm");
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,15);
   h_gammaD_1_cT->SetBinContent(1,0.2111718);
   h_gammaD_1_cT->SetBinContent(2,0.07896923);
   h_gammaD_1_cT->SetBinContent(3,0.02858797);
   h_gammaD_1_cT->SetBinContent(4,0.01048561);
   h_gammaD_1_cT->SetBinContent(5,0.004118748);
   h_gammaD_1_cT->SetBinContent(6,0.002201978);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,15);
   h_gammaD_2_cT->SetBinContent(1,0.2123672);
   h_gammaD_2_cT->SetBinContent(2,0.07723511);
   h_gammaD_2_cT->SetBinContent(3,0.02904916);
   h_gammaD_2_cT->SetBinContent(4,0.01059613);
   h_gammaD_2_cT->SetBinContent(5,0.004085759);
   h_gammaD_2_cT->SetBinContent(6,0.002248426);
