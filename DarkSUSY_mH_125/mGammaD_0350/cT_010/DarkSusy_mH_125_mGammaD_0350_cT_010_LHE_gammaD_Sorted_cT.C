...
//=========  (Mon Mar 16 12:46:16 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.857845,0.51875,12.43327);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.43289);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.362217);
   h_gammaD_1_cT->SetBinContent(2,2.332515);
   h_gammaD_1_cT->SetBinContent(3,0.8641369);
   h_gammaD_1_cT->SetBinContent(4,0.3273551);
   h_gammaD_1_cT->SetBinContent(5,0.1137751);
   h_gammaD_1_cT->SetBinContent(6,0.06846642);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.351606);
   h_gammaD_2_cT->SetBinContent(2,2.360496);
   h_gammaD_2_cT->SetBinContent(3,0.8608229);
   h_gammaD_2_cT->SetBinContent(4,0.3103596);
   h_gammaD_2_cT->SetBinContent(5,0.1167153);
   h_gammaD_2_cT->SetBinContent(6,0.07239626);
