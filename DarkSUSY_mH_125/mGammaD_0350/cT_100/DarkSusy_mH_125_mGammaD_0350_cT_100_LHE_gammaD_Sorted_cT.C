...
//=========  (Mon Mar 16 12:56:36 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.1856509,5.1875,1.242433);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,5);
   h_gammaD_1_cT_dummy->SetMaximum(1.142467);
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,5);
   h_gammaD_1_cT->SetBinContent(1,0.638446);
   h_gammaD_1_cT->SetBinContent(2,0.2313327);
   h_gammaD_1_cT->SetBinContent(3,0.08704079);
   h_gammaD_1_cT->SetBinContent(4,0.03155166);
   h_gammaD_1_cT->SetBinContent(5,0.01162893);
   h_gammaD_1_cT->SetBinContent(6,0.006821299);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,5);
   h_gammaD_2_cT->SetBinContent(1,0.6347039);
   h_gammaD_2_cT->SetBinContent(2,0.2373235);
   h_gammaD_2_cT->SetBinContent(3,0.08516822);
   h_gammaD_2_cT->SetBinContent(4,0.03159365);
   h_gammaD_2_cT->SetBinContent(5,0.01121065);
   h_gammaD_2_cT->SetBinContent(6,0.006555273);
