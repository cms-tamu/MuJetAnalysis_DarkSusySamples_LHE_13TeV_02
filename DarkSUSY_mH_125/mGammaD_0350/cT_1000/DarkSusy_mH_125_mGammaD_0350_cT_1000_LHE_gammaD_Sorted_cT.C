...
//=========  (Wed Mar 18 13:32:44 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01863924,51.875,0.1247396);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.114703);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06392591);
   h_gammaD_1_cT->SetBinContent(2,0.02317566);
   h_gammaD_1_cT->SetBinContent(3,0.008623705);
   h_gammaD_1_cT->SetBinContent(4,0.003156027);
   h_gammaD_1_cT->SetBinContent(5,0.001118703);
   h_gammaD_1_cT->SetBinContent(6,0.0006694603);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06372391);
   h_gammaD_2_cT->SetBinContent(2,0.02334777);
   h_gammaD_2_cT->SetBinContent(3,0.008528664);
   h_gammaD_2_cT->SetBinContent(4,0.003216345);
   h_gammaD_2_cT->SetBinContent(5,0.001183313);
   h_gammaD_2_cT->SetBinContent(6,0.0007062111);
