...
//=========  (Mon Mar 16 12:53:05 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.371851,2.59375,2.488542);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.288314);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.27807);
   h_gammaD_1_cT->SetBinContent(2,0.4606479);
   h_gammaD_1_cT->SetBinContent(3,0.1725856);
   h_gammaD_1_cT->SetBinContent(4,0.06503738);
   h_gammaD_1_cT->SetBinContent(5,0.02365911);
   h_gammaD_1_cT->SetBinContent(6,0.01351589);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.271286);
   h_gammaD_2_cT->SetBinContent(2,0.4712353);
   h_gammaD_2_cT->SetBinContent(3,0.1702347);
   h_gammaD_2_cT->SetBinContent(4,0.06426279);
   h_gammaD_2_cT->SetBinContent(5,0.02298156);
   h_gammaD_2_cT->SetBinContent(6,0.01369329);
