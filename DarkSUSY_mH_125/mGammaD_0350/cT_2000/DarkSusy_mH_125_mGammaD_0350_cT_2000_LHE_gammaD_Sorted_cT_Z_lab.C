...
//=========  (Wed Mar 18 13:32:58 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-21.25,-0.004501346,103.75,0.03012439);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",5,0,100);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(0.02770059);
   ...
   h_gammaD_1_cT_Z_lab_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 20.0 mm");
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",5,0,100);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.01423389);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.01050913);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.009457008);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.008308139);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.007491837);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,0.4337284);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",5,0,100);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.01538922);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.01153294);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.009166517);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.007293724);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.006617603);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,0.1893317);
