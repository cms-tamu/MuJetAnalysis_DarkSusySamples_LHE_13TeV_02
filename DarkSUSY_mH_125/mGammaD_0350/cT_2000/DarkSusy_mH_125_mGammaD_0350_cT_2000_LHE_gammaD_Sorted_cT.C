...
//=========  (Wed Mar 18 13:32:51 2015) by ROOT version5.34/18
   ...
   cnv->Range(-21.25,-0.009308341,103.75,0.06229429);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.0572821);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03176674);
   h_gammaD_1_cT->SetBinContent(2,0.01174282);
   h_gammaD_1_cT->SetBinContent(3,0.004252895);
   h_gammaD_1_cT->SetBinContent(4,0.00161002);
   h_gammaD_1_cT->SetBinContent(5,0.0006275176);
   h_gammaD_1_cT->SetBinContent(6,0.0003518379);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03182339);
   h_gammaD_2_cT->SetBinContent(2,0.01172845);
   h_gammaD_2_cT->SetBinContent(3,0.004296255);
   h_gammaD_2_cT->SetBinContent(4,0.00154499);
   h_gammaD_2_cT->SetBinContent(5,0.0006069153);
   h_gammaD_2_cT->SetBinContent(6,0.0003657861);
