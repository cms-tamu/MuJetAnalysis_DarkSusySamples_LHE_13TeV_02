...
//=========  (Mon Mar 16 13:00:17 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.04697255,10.375,0.3143547);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_Z_lab_dummy = new TH1F("h_gammaD_1_cT_Z_lab_dummy","h_gammaD_1_cT_Z_lab_dummy",5,0,10);
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(0.2890618);
   ...
   h_gammaD_1_cT_Z_lab_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 2.0 mm");
   ...
   TH1F *h_gammaD_1_cT_Z_lab = new TH1F("h_gammaD_1_cT_Z_lab","h_gammaD_1_cT_Z_lab",5,0,10);
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.1371557);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.1113819);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.09486961);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.08280526);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.07378747);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,4.374421);
   ...
   TH1F *h_gammaD_2_cT_Z_lab = new TH1F("h_gammaD_2_cT_Z_lab","h_gammaD_2_cT_Z_lab",5,0,10);
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.1605899);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.1130156);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.08921325);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.07295137);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.06422991);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,1.922597);
