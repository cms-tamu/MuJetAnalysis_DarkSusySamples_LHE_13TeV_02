...
//=========  (Mon Mar 16 13:00:12 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09271778,10.375,0.6204959);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,10);
   h_gammaD_1_cT_dummy->SetMaximum(0.570571);
   ...
   h_gammaD_1_cT_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 2.0 mm");
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,10);
   h_gammaD_1_cT->SetBinContent(1,0.3182596);
   h_gammaD_1_cT->SetBinContent(2,0.1177185);
   h_gammaD_1_cT->SetBinContent(3,0.04228277);
   h_gammaD_1_cT->SetBinContent(4,0.01592525);
   h_gammaD_1_cT->SetBinContent(5,0.00581388);
   h_gammaD_1_cT->SetBinContent(6,0.00335997);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,10);
   h_gammaD_2_cT->SetBinContent(1,0.3169839);
   h_gammaD_2_cT->SetBinContent(2,0.1173374);
   h_gammaD_2_cT->SetBinContent(3,0.0434315);
   h_gammaD_2_cT->SetBinContent(4,0.01615866);
   h_gammaD_2_cT->SetBinContent(5,0.006088587);
   h_gammaD_2_cT->SetBinContent(6,0.00318267);
