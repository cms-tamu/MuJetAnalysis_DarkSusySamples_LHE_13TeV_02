...
//=========  (Wed Mar 18 13:33:04 2015) by ROOT version5.34/18
   ...
   cnv->Range(-53.125,-0.003733887,259.375,0.02498832);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,250);
   h_gammaD_1_cT_dummy->SetMaximum(0.02297777);
   ...
   h_gammaD_1_cT_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 50.0 mm");
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,250);
   h_gammaD_1_cT->SetBinContent(1,0.01273272);
   h_gammaD_1_cT->SetBinContent(2,0.004693042);
   h_gammaD_1_cT->SetBinContent(3,0.001709696);
   h_gammaD_1_cT->SetBinContent(4,0.0006220969);
   h_gammaD_1_cT->SetBinContent(5,0.0002424441);
   h_gammaD_1_cT->SetBinContent(6,0.0001404816);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,250);
   h_gammaD_2_cT->SetBinContent(1,0.01276543);
   h_gammaD_2_cT->SetBinContent(2,0.004655958);
   h_gammaD_2_cT->SetBinContent(3,0.001715048);
   h_gammaD_2_cT->SetBinContent(4,0.0006311841);
   h_gammaD_2_cT->SetBinContent(5,0.0002323825);
   h_gammaD_2_cT->SetBinContent(6,0.0001412422);
