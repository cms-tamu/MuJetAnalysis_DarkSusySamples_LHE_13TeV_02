...
//=========  (Mon Mar 16 13:07:27 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03698201,25.9375,0.247495);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   TH1F *h_gammaD_1_cT_dummy = new TH1F("h_gammaD_1_cT_dummy","h_gammaD_1_cT_dummy",5,0,25);
   h_gammaD_1_cT_dummy->SetMaximum(0.2275816);
   ...
   h_gammaD_1_cT_dummy->GetYaxis()->SetTitle("Normalized Fraction of events / 5.0 mm");
   ...
   TH1F *h_gammaD_1_cT = new TH1F("h_gammaD_1_cT","h_gammaD_1_cT",5,0,25);
   h_gammaD_1_cT->SetBinContent(1,0.1273077);
   h_gammaD_1_cT->SetBinContent(2,0.04668529);
   h_gammaD_1_cT->SetBinContent(3,0.01745792);
   h_gammaD_1_cT->SetBinContent(4,0.006224369);
   h_gammaD_1_cT->SetBinContent(5,0.002324704);
   h_gammaD_1_cT->SetBinContent(6,0.001270536);
   ...
   TH1F *h_gammaD_2_cT = new TH1F("h_gammaD_2_cT","h_gammaD_2_cT",5,0,25);
   h_gammaD_2_cT->SetBinContent(1,0.1264342);
   h_gammaD_2_cT->SetBinContent(2,0.04755192);
   h_gammaD_2_cT->SetBinContent(3,0.01712272);
   h_gammaD_2_cT->SetBinContent(4,0.006464443);
   h_gammaD_2_cT->SetBinContent(5,0.002426683);
   h_gammaD_2_cT->SetBinContent(6,0.001382001);
